...
export const WORLD_CUP_EDITIONS: Record<number, WorldCupEdition> = {
  ...
  1966: {
    ...
    mascot: { name: "World Cup Willie", description: "An anthropomorphic lion wearing a Union Jack jersey — the first-ever World Cup mascot." },
  },
  1970: {
    year: 1970, host: "Mexico", logoUrl: "/images/world-cup/logos/1970.png",
    mascot: { name: "Juanito", description: "A boy wearing Mexico's kit and a sombrero with 'MEXICO 70' on it." },
  },
  1974: {
    year: 1974, host: "West Germany", logoUrl: "/images/world-cup/logos/1974.png",
    mascot: { name: "Tip and Tap", description: "Two boys wearing Germany's kits with 'WM 74' on them." },
  },
  1978: {
    year: 1978, host: "Argentina", logoUrl: "/images/world-cup/logos/1978.png",
    mascot: { name: "Gauchito", description: "A boy wearing Argentina's kit with a hat, neckerchief and whip typical of gauchos." },
  },
  1982: {
    year: 1982, host: "Spain", logoUrl: "/images/world-cup/logos/1982.png",
    mascot: { name: "Naranjito", description: "An anthropomorphic orange wearing Spain's national team kit." },
  },
  1986: {
    year: 1986, host: "Mexico", logoUrl: "/images/world-cup/logos/1986.png",
    mascot: { name: "Pique", description: "An anthropomorphic jalapeño pepper with a moustache and sombrero." },
  },
  1990: {
    year: 1990, host: "Italy", logoUrl: "/images/world-cup/logos/1990.png",
    mascot: { name: "Ciao", description: "A stick figure player with a football head and Italian tricolore body." },
  },
  1994: {
    year: 1994, host: "United States", logoUrl: "/images/world-cup/logos/1994.png",
    mascot: { name: "Striker", description: "An anthropomorphic dog wearing a red, white, and blue soccer uniform." },
  },
  1998: {
    year: 1998, host: "France", logoUrl: "/images/world-cup/logos/1998.png",
    mascot: { name: "Footix", description: "An anthropomorphic cockerel, a national symbol of France, with 'FRANCE 98' on his chest." },
  },
  2002: {
    year: 2002, host: "South Korea / Japan", logoUrl: "/images/world-cup/logos/2002.png",
    mascot: { name: "Ato, Kaz and Nik", description: "Three futuristic 'Atmosball' creatures — Ato the coach, Kaz and Nik the players." },
  },
  2006: {
    year: 2006, host: "Germany", logoUrl: "/images/world-cup/logos/2006.png",
    mascot: { name: "Goleo VI & Pille", description: "An anthropomorphic lion wearing a Germany shirt with a talking football named Pille." },
  },
  2010: {
    year: 2010, host: "South Africa", logoUrl: "/images/world-cup/logos/2010.png",
    mascot: { name: "Zakumi", description: "An anthropomorphic leopard with green hair, representing South African sports colors." },
  },
  2014: {
    year: 2014, host: "Brazil", logoUrl: "/images/world-cup/logos/2014.png",
    mascot: { name: "Fuleco", description: "An anthropomorphic Brazilian three-banded armadillo, a vulnerable species endemic to Brazil." },
  },
  2018: {
    year: 2018, host: "Russia", logoUrl: "/images/world-cup/logos/2018.png",
    mascot: { name: "Zabivaka", description: "An anthropomorphic wolf whose name means 'The Goalscorer' in Russian." },
  },
  2022: {
    year: 2022, host: "Qatar", logoUrl: "/images/world-cup/logos/2022.png",
    mascot: { name: "La'eeb", description: "A white floating anthropomorphic ghutrah meaning 'super-skilled player' in Arabic." },
  },
  2026: {
    year: 2026, host: "USA / Canada / Mexico", logoUrl: "/images/world-cup/logos/2026.png",
    mascot: { name: "Maple, Zayu & Clutch", description: "Maple the Moose (Canada), Zayu the Jaguar (Mexico), and Clutch the Bald Eagle (USA)." },
  },
};
