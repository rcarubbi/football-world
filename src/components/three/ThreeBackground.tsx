...
function Goals() {
  ...
  const [{ g2PosX, g2PosY, g2PosZ, g2RotX, g2RotY, g2RotZ, g2Scl, showGoal2 }, setGoal2] = useControls(() => ({
    "Goal 2": folder({
      ...
      g2RotY: { value: 1.59, min: -Math.PI, max: Math.PI, step: 0.01 },
      g2RotZ: { value: -0.11, min: -Math.PI, max: Math.PI, step: 0.01 },
  ...
  return (
    <>
      {showGoal1 && (
        <primitive
          object={goal1}
          position={[g1PosX, g1PosY, g1PosZ]}
          rotation={[g1RotX, g1RotY, g1RotZ]}
          scale={g1Scl}
        />
      )}
      {showGoal2 && (
        <primitive
          object={goal2}
          position={[g2PosX, g2PosY, g2PosZ]}
          rotation={[g2RotX, g2RotY, g2RotZ]}
          scale={g2Scl}
        />
      )}
    </>
...
const Scene = memo(function Scene() {
  ...
  const [spot1, setSpot1] = useControls(() => ({
    "Spotlight 1": folder({
      ...
      spot1Y: { value: 1.6, min: -10, max: 10, step: 0.1 },
      spot1Z: { value: 2.3, min: -10, max: 10, step: 0.1 },
      spot1RotX: { value: 0.59, min: -Math.PI, max: Math.PI, step: 0.01 },
      spot1RotY: { value: -2.48, min: -Math.PI, max: Math.PI, step: 0.01 },
      spot1Intensity: { value: 20, min: 0, max: 20, step: 0.1 },
      ...
      point1X: { value: 2.5, min: -10, max: 10, step: 0.1 },
      point1Y: { value: 1.6, min: -10, max: 10, step: 0.1 },
      point1Z: { value: 2.2, min: -10, max: 10, step: 0.1 },
      point1Intensity: { value: 8.7, min: 0, max: 20, step: 0.1 },
  ...
  const [spot2, setSpot2] = useControls(() => ({
    "Spotlight 2": folder({
      ...
      spot2Y: { value: 1.6, min: -10, max: 10, step: 0.1 },
      spot2Z: { value: 2, min: -10, max: 10, step: 0.1 },
      spot2RotX: { value: 0.59, min: -Math.PI, max: Math.PI, step: 0.01 },
      spot2RotY: { value: 2.48, min: -Math.PI, max: Math.PI, step: 0.01 },
      spot2Intensity: { value: 20, min: 0, max: 20, step: 0.1 },
      ...
      point2X: { value: -2.5, min: -10, max: 10, step: 0.1 },
      point2Y: { value: 1.6, min: -10, max: 10, step: 0.1 },
      point2Z: { value: 2.2, min: -10, max: 10, step: 0.1 },
      point2Intensity: { value: 8.7, min: 0, max: 20, step: 0.1 },
  ...
  useEffect(() => {
    if (pathname === "/") {
      ...
      setCamera({ lookX: 0, lookY: -1, lookZ: 0, fov: 45, useRotation: false, override: false });
